...
module frontend #(
  ...
  bpu #(
      ...
      .TAGE_BASE_ENTRIES(Cfg.BPU_TAGE_BASE_ENTRIES),
      ...
      .SC_NUM_TABLES(Cfg.BPU_SC_NUM_TABLES),
      .SC_CTR_BITS(Cfg.BPU_SC_CTR_BITS),
      .SC_HIST_LEN1(Cfg.BPU_SC_HIST1),
      .SC_HIST_LEN2(Cfg.BPU_SC_HIST2),
      .SC_HIST_LEN3(Cfg.BPU_SC_HIST3),
      .SC_THRESH_INIT(Cfg.BPU_SC_THRESH_INIT),
