...
module tb_triathlon #(
  ...
  assign dbg_bpu_cond_update_total_o = dut.u_frontend.i_bpu.u_bht.dbg_cond_update_total_q;
  assign dbg_bpu_cond_local_correct_o = dut.u_frontend.i_bpu.u_bht.dbg_cond_local_correct_q;
  assign dbg_bpu_cond_global_correct_o = dut.u_frontend.i_bpu.u_bht.dbg_cond_global_correct_q;
