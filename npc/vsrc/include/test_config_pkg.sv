...
package test_config_pkg;
  ...
  localparam config_pkg::user_cfg_t TestCfg = '{
      ...
      BPU_BTB_ENTRIES : unsigned'(1024),
      BPU_BHT_ENTRIES : unsigned'(512),
      BPU_TAGE_BASE_ENTRIES : unsigned'(1024),
      BPU_RAS_DEPTH : unsigned'(16),
      BPU_GHR_BITS : unsigned'(32),
      BPU_USE_SC : unsigned'(1),
      BPU_SC_ENTRIES : unsigned'(512),
      BPU_SC_CONF_THRESH : unsigned'(1),
      BPU_SC_REQUIRE_BOTH_WEAK : unsigned'(1),
      BPU_SC_BLOCK_ON_TAGE_HIT : unsigned'(0),
      BPU_SC_NUM_TABLES : unsigned'(4),
      BPU_SC_CTR_BITS : unsigned'(6),
      BPU_SC_HIST1 : unsigned'(8),
      BPU_SC_HIST2 : unsigned'(16),
      ...
      BPU_USE_ITTAGE : unsigned'(0),
      BPU_ITTAGE_ENTRIES : unsigned'(128),
      BPU_ITTAGE_TAG_BITS : unsigned'(10),
      BPU_TAGE_OVERRIDE_MIN_PROVIDER : unsigned'(2),
      BPU_TAGE_OVERRIDE_REQUIRE_LEGACY_WEAK : unsigned'(0),
      BPU_TAGE_TAG_BITS : unsigned'(8),
      BPU_TAGE_HIST_LEN0 : unsigned'(4),
      BPU_TAGE_HIST_LEN1 : unsigned'(9),
      BPU_TAGE_HIST_LEN2 : unsigned'(18),
      BPU_TAGE_HIST_LEN3 : unsigned'(32),
      ...
      LSU_GROUP_SIZE : unsigned'(8),
      SB_DEPTH : unsigned'(32),
      IBUFFER_DEPTH : unsigned'(16),
      ROB_MAX_COMMIT_BR : unsigned'(1),
      ROB_MAX_COMMIT_ST : unsigned'(2),
