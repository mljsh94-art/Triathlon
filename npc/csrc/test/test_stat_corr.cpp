...
static void train(Vtb_stat_corr *top, uint32_t pc, uint8_t ghr, bool taken) {
...
static void predict(Vtb_stat_corr *top, uint32_t base_pc, uint8_t ghr) {
...
int main(int argc, char **argv) {
  ...
  std::cout << "--- [PASSED] stat_corr saturating correction behavior ---" << std::endl;
  delete top;
  return 0;
}
